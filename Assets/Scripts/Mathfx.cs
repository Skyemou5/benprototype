...
public sealed class Mathfx
{
    ...
    public static Vector4 Hermite(Vector4 start, Vector4 end, float value)
    {
        return new Vector4(Hermite(start.x, end.x, value), Hermite(start.y, end.y, value), Hermite(start.z, end.z, value), Hermite(start.z, end.z, value));
    }
    ...
    public static Vector4 Sinerp(Vector4 start, Vector4 end, float value)
    {
        return new Vector4(Sinerp(start.x, end.x, value), Sinerp(start.y, end.y, value), Sinerp(start.z, end.z, value), Sinerp(start.z, end.z, value));
    }
    ...
    public static Vector4 Coserp(Vector4 start, Vector4 end, float value)
    {
        return new Vector4(Coserp(start.x, end.x, value), Coserp(start.y, end.y, value), Coserp(start.z, end.z, value), Coserp(start.z, end.z, value));
    }
